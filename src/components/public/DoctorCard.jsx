    ...
    >
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 14 }}>
        ...
        >
          {avatar ? (
            ...
            <Stethoscope size={28} strokeWidth={2.3} color="#6366f1" />
          )}
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {experience && (
            ...
            >
              <BriefcaseMedical size={11} strokeWidth={2.2} color="#94a3b8" />
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
          <IndianRupee size={15} strokeWidth={2.4} color="#94a3b8" />
        ...
        {consultationFee?.online > 0 && (
          ...
          >
            <Video size={11} strokeWidth={2.3} color="#6366f1" />
