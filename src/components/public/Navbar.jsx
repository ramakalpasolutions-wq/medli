...
const USER_MENU = [
  ...
  { icon: CalendarDays, label: 'Bookings', href: '/user/bookings' },
  { icon: User, label: 'Profile', href: '/user/profile' },
  { icon: Users, label: 'Family Members', href: '/user/profile?tab=family' },
  { icon: FileText, label: 'Invoices', href: '/user/invoices' },
]
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <Menu size={20} color="#475569" strokeWidth={2.2} />
          </button>
        </div>
      </nav>
        ...
        {USER_MENU.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.label}
              <ChevronRight size={14} style={{ marginLeft: 'auto', color: '#c4b5fd' }} />
            </a>
          )
        })}
      </div>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <a
        ...
        style={{
          ...
          boxShadow: sh ? '0 6px 22px rgba(99,102,241,.5)' : '0 4px 14px rgba(99,102,241,.3)',
    ...
    <>
      <div
        ...
        style={{
          ...
          animation: closing ? 'nb-fadeIn .28s ease reverse' : 'nb-fadeIn .22s ease forwards',
        }}
      />
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 8, color: '#94a3b8', letterSpacing: '1.5px', fontWeight: 600 }}>
            HEALTHCARE
          </div>
        </div>
      </div>
...
function DrawerLink({ href, icon: Icon, label, active, onClick }) {
  const [h, setH] = useState(false)
  ...
  return (
    ...
    >
      ...
      {(active || h) && <ChevronRight size={15} color={active ? '#6366f1' : '#94a3b8'} />}
    </a>
  )
}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <a
            ...
            style={{
              ...
              color: '#fff',
              textDecoration: 'none',
              boxShadow: sh ? '0 8px 28px rgba(99,102,241,.5)' : '0 4px 16px rgba(99,102,241,.3)',
