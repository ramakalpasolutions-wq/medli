...
const NAV_ITEMS = [
  ...
  { label: 'Bookings', href: '/hospital-admin/bookings', icon: CalendarDays },
  ...
  { label: 'Coupons', href: '/hospital-admin/coupons', icon: TicketPercent },
  { label: 'Settlements', href: '/hospital-admin/settlements', icon: Wallet },
  { label: 'Analytics', href: '/hospital-admin/reports', icon: BarChart3 },
  { label: 'Settings', href: '/hospital-admin/settings', icon: Settings },
  { label: 'Support', href: '/hospital-admin/support', icon: LifeBuoy },
]
