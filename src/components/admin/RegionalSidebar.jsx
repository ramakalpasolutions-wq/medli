...
const NAV_ITEMS = [
  ...
  { label: 'Hospitals', href: '/regional/hospitals', icon: Building2 },
  { label: 'Labs', href: '/regional/labs', icon: FlaskConical },
  { label: 'Bookings', href: '/regional/bookings', icon: CalendarDays },
  { label: 'Settlements', href: '/regional/settlements', icon: Wallet },
  { label: 'Analytics', href: '/regional/analytics', icon: BarChart3 },
  { label: 'Reports', href: '/regional/reports', icon: FileText },
]

const KF = `
  @keyframes rg-slide { from{transform:translateX(-100%)} to{transform:translateX(0)} }
  ...
  return (
    <a
      ...
      style={{
        ...
        color: active ? '#fdba74' : h ? 'rgba(255,255,255,0.75)' : 'rgba(255,255,255,0.45)',
        fontSize: 13,
      ...
      {user && (
        ...
        >
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            >
              {user.email || (user.phone ? `+91 ${user.phone}` : 'Regional Manager')}
            </p>
          </div>
        </div>
      )}
    ...
    >
      <button
        ...
        style={{
          ...
          borderRadius: 10,
          border: 'none',
          background: h ? 'rgba(249,115,22,0.2)' : 'rgba(255,255,255,0.06)',
          cursor: 'pointer',
          gridColumn: 1,
          display: 'flex',
          alignItems: 'center',
    ...
    <>
      ...
      <style>{`
        @media(min-width:1024px){
          .rg-desktop      { display:block !important; }
          .rg-mobile-topbar{ display:none  !important; }
        }
        @media(max-width:1023px){
          .rg-desktop      { display:none !important; }
          .rg-mobile-topbar{ display:grid !important; }
        }
      `}</style>

      <aside
        className="rg-desktop"
        ...
        <>
          ...
          <aside
            style={{
              ...
              zIndex: 910,
              animation: 'rg-slide .28s cubic-bezier(0.34,1.56,0.64,1)',
