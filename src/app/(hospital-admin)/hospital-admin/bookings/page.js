    ...
    <div style={{ position: 'relative', flex: 1, minWidth: 180, maxWidth: 320 }}>
      ...
      <input
        ...
        style={{
          ...
          fontSize: 13, fontFamily: 'inherit', borderRadius: 12, boxSizing: 'border-box',
          ...
          >
            {loading && (
              <span style={{
                ...
                animation: 'bk-spin .7s linear infinite', display: 'inline-block',
              }} />
            )}
            Cancel Booking
          </button>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      {(b.userName || b.userPhone) && (
        <div style={{
          ...
          <div style={{
            ...
            {b.userName?.charAt(0)?.toUpperCase() || 'P'}
          </div>
          <div>
      ...
      <div style={{
        ...
        {[
          ...
          <div key={r.label} style={{
            ...
            <p style={{
              fontSize: r.bold ? 16 : 14, fontWeight: r.bold ? 800 : 600,
              color: r.bold ? '#15803d' : '#1e293b', margin: 0,
            }}>
              {r.value}
            </p>
          </div>
      ...
      <div style={{
        ...
        {[
          { l: 'Date & Time',  v: mounted && b.startTime ? new Date(b.startTime).toLocaleString('en-IN', { dateStyle: 'long', timeStyle: 'short' }) : '—' },
...
export default function HospitalAdminBookings() {
  ...
  return (
    <>
      ...
      <CancelModal
        open={cancelOpen}
        onClose={() => { setCancelOpen(false); setTargetId(null) }}
