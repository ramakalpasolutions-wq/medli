    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      >
        {[
          ...
          {
            label: 'Refunds',
            value: fmtRs(s.refundsDeducted),
            red: Number(s.refundsDeducted) > 0,
          },
          ...
          <div
            ...
            style={{
              ...
              borderRadius: 12,
              border: `1px solid ${
                r.green ? '#bbf7d0' : r.red ? '#fecaca' : '#f1f5f9'
              }`,
            }}
          >
            <p
            ...
            >
              {r.red && Number(s.refundsDeducted) > 0 ? '- ' : ''}
              {r.value}
            </p>
          </div>
        ))}
...
export default function LabSettlements() {
  ...
  useEffect(() => {
    ...
    setBankForm({
      accountHolderName: lab.accountHolderName || lab.bankAccount?.accountHolderName || '',
      accountNumber: lab.accountNumber || lab.bankAccount?.accountNumber || '',
      ifscCode: lab.ifscCode || lab.bankAccount?.ifscCode || '',
      bankName: lab.bankName || lab.bankAccount?.bankName || '',
      upiId: lab.upiId || lab.bankAccount?.upiId || '',
    })
  }, [lab])
        ...
        >
          ...
          >
            {[
              {
                label: 'Test Revenue',
                value: fmtRs(myPending.grossAmount),
                sub: `${myPending.totalBookings} bookings`,
              },
              {
                label: 'Refunds Deducted',
                value:
                  myPending.refundsDeducted > 0
                    ? `- ${fmtRs(myPending.refundsDeducted)}`
                    : 'None',
                sub: 'Cancelled bookings',
                red: myPending.refundsDeducted > 0,
              },
              {
                label: 'You Will Receive',
                value: fmtRs(myPending.netSettlementAmount),
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          >
            <BInput
              ...
              onChange={(e) =>
                setBankForm((f) => ({ ...f, ifscCode: e.target.value.toUpperCase() }))
              }
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                border: 'none',
                background: bankSaving ? '#e2e8f0' : 'linear-gradient(135deg,#10b981,#059669)',
