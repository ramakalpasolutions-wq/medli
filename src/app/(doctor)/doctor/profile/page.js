...
const SPECIALIZATIONS = [
  ...
  'Interventional Cardiology','ENT Specialist','Psychiatrist','Oncologist',
...
/* ─── Tag Input (for specialization, qualifications) ─────────────────── */
            ...
            <span key={i} style={{
              ...
              <button
                ...
                style={{
                  ...
                  color: '#6366f1', padding: 0, fontSize: 14, lineHeight: 1,
                }}
              >×</button>
            </span>
          ))}
  ...
  return (
    <button
      ...
      style={{
        ...
        background: isLoading ? '#cbd5e1'
          : h ? 'linear-gradient(135deg,#7c3aed,#6d28d9)'
              : 'linear-gradient(135deg,#6366f1,#8b5cf6)',
        color: '#fff', fontSize: 13, fontWeight: 600,
        cursor: isLoading ? 'not-allowed' : 'pointer',
        boxShadow: isLoading ? 'none'
          : h ? '0 6px 20px rgba(99,102,241,0.45)' : '0 4px 14px rgba(99,102,241,0.3)',
...
/* ─── Section Card ───────────────────────────────────────────────────── */
function PCard({ title, subtitle, action, children }) {
  return (
    <div style={{
...
function StatTile({ icon, label, value, color = '#6366f1' }) {
  return (
    <div style={{
      ...
      <div>
        <p style={{ fontSize: 11, color: '#94a3b8', margin: 0, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
          {label}
        </p>
...
export default function DoctorProfilePage() {
  ...
  /* ── Also fetch full doctor record (with all fields) ── */
  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        ...
        <PCard
          title="👨‍⚕️ Professional Information"
        ...
        >
          ...
          <p style={{ fontSize: 11, color: '#94a3b8', margin: '12px 0 0', display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {hospital && (
          <PCard title="🏥 Affiliated Hospital" subtitle="Set by hospital admin">
            <div style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginTop: 6 }}>
                  {hospital.contactPhone && (
                    <span style={{ fontSize: 12, color: '#64748b' }}>📞 {hospital.contactPhone}</span>
                  )}
                  {hospital.contactEmail && (
                    <span style={{ fontSize: 12, color: '#64748b' }}>✉️ {hospital.contactEmail}</span>
                  )}
                </div>
        ...
        {/* ═══ CONSULTATION TYPES (read-only — managed in Availability) ═ */}
