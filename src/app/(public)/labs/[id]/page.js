...
function CartBar({ cart, labId, router }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 12, flexWrap: 'wrap' }}>
        <p style={{ fontSize: 11, color: '#94a3b8', margin: 0, display: 'inline-flex', alignItems: 'center', gap: 5 }}>
          <TestTubeDiagonal size={13} strokeWidth={2.2} />
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f8fafc', paddingBottom: cart.length ? 80 : 0 }}>
          ...
          >
            ...
            >
              {lab?.images?.logo ? (
                ...
                <TestTubeDiagonal size={26} color="#059669" strokeWidth={2.2} />
              )}
            </div>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {lab?.address?.city && (
                <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.8)', margin: '0 0 4px', display: 'inline-flex', alignItems: 'center', gap: 5 }}>
        ...
        <CartBar cart={cart} labId={id} router={router} />
        <Footer />
      </div>
    </>
  )
