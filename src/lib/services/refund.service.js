...
import { process1PayRefund } from '@/lib/services/payment.service'
import { generateRefundNumber } from '@/lib/utils/helpers'
import { emailQueue, smsQueue } from '@/lib/queues/setup'
    ...
    if (refundResult.success) {
      await prisma.refund.update({
        ...
        data: {
          ...
          onePayRefundRequestId:
            refundResult.refundRequestId,

          onePayRefundStatus:
            refundResult.onePayRefundStatus,
